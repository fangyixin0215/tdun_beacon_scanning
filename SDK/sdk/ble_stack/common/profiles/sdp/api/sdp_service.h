...
struct sdp_env_tag
{
	...
	ke_state_t state[BLE_NB_PROFILES_ADD_MAX];
};
...
{
    uint16_t used_status[BLE_CONNECTION_MAX][BLE_NB_PROFILES_ADD_MAX];
    uint8_t sdp_need_discover[BLE_CONNECTION_MAX][BLE_NB_PROFILES_ADD_MAX];
    struct sdp_env_tag sdp_env[BLE_CONNECTION_MAX][BLE_NB_PROFILES_ADD_MAX];
};
