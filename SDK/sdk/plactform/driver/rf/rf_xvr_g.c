...
void init_analog_xvr_reg(void)
{
	...
	mHWreg_Assign_XVR_Regsiter(04, 0x5F93FF30);///0x7F935eb7);// 0x5F915727  1017
	XVR_ANALOG_REG_BAK[0x04] = 0x5F93FF30;//0x7F935eb7;

	mHWreg_Assign_XVR_Regsiter(05, 0x48287500)//;0x48285540);//0x48295540);// 0x48285540
	XVR_ANALOG_REG_BAK[0x05] = 0x48287500;//0x48285540;

	mHWreg_Assign_XVR_Regsiter(06, 0xE1DF0C00);//0x88D68C10);   // for adc
	XVR_ANALOG_REG_BAK[0x06] = 0xE1DF0C00;//0x88D68C10;//
	...
	mHWreg_Assign_XVR_Regsiter(0B, 0xD3DD241C);//0xD05D241C);//0xD2FD260C);///buck output 1.4v///0xD1FD260C//0xd1Fd240C); //0xD3DD240C  71FD240C
	XVR_ANALOG_REG_BAK[0x0B] = 0xD3DD241C;//0xD05D241C;//0xD2FD260C;
...
void initial_xver_BK3435V2_openLoop(void)
{
    ...
    mHWreg_Assign_XVR_Regsiter(3B, 0x22341048);//);22341644
